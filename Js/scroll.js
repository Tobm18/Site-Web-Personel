...
document.querySelector('a[href="#Accueil"]').addEventListener('click', function (e) {
...
document.querySelector('.menu-incolumn a[href="#Accueil"]').addEventListener('click', function (e) {
    e.preventDefault(); 
...
document.querySelector('.menu-incolumn a[href="#About"]').addEventListener('click', function (e) {
    e.preventDefault();
